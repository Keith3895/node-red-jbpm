...
module.exports = function (RED) {
    function listTasksNode(config) {
        ...
        this.on('input', function (msg) {
            ...
            var Status = msg.Status || config.Status || "Created";
            ...
            if (validator.isURL(config.url)  && !validator.isEmpty(groups) && !validator.isEmpty(user_id) && !validator.isEmpty(password)) {
                ...
                let finalurl = config.url + '/queries/tasks/instances/pot-owners?status=' + Status + '&groups=' 
                + groups + '&user=' + user + '&page=' + page + '&pageSize=' + pageSize + '&sortOrder=' + sortOrder;
                var options = {
                    method: 'GET',
                    uri: finalurl,
                    headers: {
