...
module.exports = function (RED) {
    function checkInNode(config) {
        ...
        this.on('input', function (msg) {
            ...
            if (validator.isURL(config.url) && !validator.isEmpty(config.container_name) && !validator.isEmpty(task_id) && !validator.isEmpty(config.user_id) && !validator.isEmpty(config.password)) {
                ...
                var options = {
                    method: 'PUT',
                    uri: config.url + '/containers/' + container_name + '/tasks/' + task_id + '/states/claimed',
                    headers: headers
                }
                ...
                msg.statusCode = 500;
                msg.statusMessage = 'Node-red Internal server error';
