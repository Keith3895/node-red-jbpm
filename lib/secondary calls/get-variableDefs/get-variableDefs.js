...
module.exports = function (RED) {
    function getVariableDefs(config) {
        ...
        this.on('input', function (msg) {
            ...
            if (validator.isURL(config.url) && !validator.isEmpty(container_name) && !validator.isEmpty(process_id) && !validator.isEmpty(auth_header)) {
                ...
                var options = {
                    method: 'GET',
                    uri: config.url + '/containers/'+container_name+'/processes/definitions/'+process_id+'/variables',
                    headers: headers
                }
    ...
    RED.nodes.registerType('get-variableDefs', getVariableDefs);
}
