...
module.exports = function (RED) {
    function getChildProcessDetails(config) {
        ...
        this.on('input', function (msg) {
            ...
            if (validator.isURL(config.url) && !validator.isEmpty(container_name) && !validator.isEmpty(process_instance_id) && !validator.isEmpty(user_id) && !validator.isEmpty(password)) {
                ...
                var options = {
                    method: 'GET',
                    uri: config.url + '/containers/' + container_name + '/processes/instances/' + process_instance_id + '/processes',
                    headers: headers
                }
