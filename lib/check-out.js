...
module.exports = function (RED) {
    function checkOutNode(config) {
        ...
        this.on('input', function (msg) {
            ...
            if (validator.isURL(config.url) && !validator.isEmpty(container_name) && !validator.isEmpty(task_id) && !validator.isEmpty(user_id) && !validator.isEmpty(password)) {
                ...
                var options = {
                    method: 'PUT',
                    uri: config.url + '/containers/' + container_name + '/tasks/' + task_id + '/states/completed',
                    headers: headers,
					body: msg.payload,
					json: true
                }
